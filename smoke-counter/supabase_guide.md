...
- Repository con questa struttura:
  - `smoke-counter/supabase/schema.sql`
  - `smoke-counter/supabase/rls.sql`
...
Nel frontend (`smoke-counter/web`):
...
2. Apri `smoke-counter/supabase/schema.sql`.
...
2. Apri `smoke-counter/supabase/rls.sql`.
